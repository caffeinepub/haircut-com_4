...
export const MOCK_SALONS: Salon[] = [
  {
    ...
    distance: 1.2,
    description:
      "Premium barbershop offering classic and modern cuts with expert barbers.",
  ...
  },
  {
    ...
    distance: 2.5,
    description:
      "Luxury beauty studio for women offering premium hair and skin treatments.",
  ...
  },
  {
    ...
    services: [
      ...
      },
      {
        ...
        price: 150,
        duration: 20,
        description: "Gentle wash and style",
      },
      {
        id: "sv14",
    ...
    distance: 0.8,
    description:
      "Child-friendly salon with patient stylists and a fun environment for kids.",
  ...
  },
  {
    ...
    services: [
      {
        ...
        price: 300,
        duration: 30,
        description: "Precision cut for all",
      },
      {
        id: "sv16",
        name: "Hair Color",
    ...
    distance: 3.1,
    description:
      "Modern unisex salon offering premium styling services for everyone.",
  ...
  },
  {
    ...
    services: [
      ...
      },
      {
        ...
        price: 600,
        duration: 60,
        description: "Nourishing hair spa",
      },
    ],
    staff: [
  ...
  },
  {
    ...
    distance: 1.8,
    description:
      "Full-service beauty parlour specializing in bridal and special occasion looks.",
...
export const MOCK_BOOKINGS: Booking[] = [
  ...
  },
  {
    ...
    services: [
      { id: "sv17", name: "Keratin Treatment", price: 2500, duration: 120 },
    ],
    date: "2025-03-05",
    timeSlot: "03:00 PM",
    status: "Pending",
...
export const MOCK_POSTS: Post[] = [
  ...
  },
  {
    ...
    caption:
      "Making every kid feel like a star! 🌟 Special weekend offers available.",
...
export function generateTimeSlots(_date: string): TimeSlot[] {
