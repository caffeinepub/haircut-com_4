...
import { Scissors, ArrowRight, Star, Users, Calendar } from 'lucide-react';
...
export function Home() {
  ...
  useEffect(() => {
    ...
    setMetaDescription('Find and book appointments at top-rated salons across India. Compare prices, read reviews, and get exclusive deals.');
    setOpenGraphTags(
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center px-4 text-center">
          <div className="space-y-4 max-w-3xl">
            <div className="flex items-center justify-center gap-2 mb-2">
              ...
              <span className="text-gold-400 font-semibold text-sm tracking-widest uppercase">Premium Grooming</span>
            </div>
            ...
            <p className="text-white/80 text-base md:text-lg max-w-xl mx-auto">
              Book top-rated salons & parlours near you. Instant confirmation, transparent pricing.
            </p>
            <div className="pt-2">
              <SearchBar />
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 space-y-10">
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-xl font-bold text-foreground">{t('featuredSalons')}</h2>
            <Button variant="ghost" size="sm" onClick={() => navigate({ to: '/search' })} className="text-gold-500 gap-1">
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-xl font-bold text-foreground">{t('trendingPosts')}</h2>
            <Button variant="ghost" size="sm" onClick={() => navigate({ to: '/feed' })} className="text-gold-500 gap-1">
              {t('viewAll')} <ArrowRight className="w-4 h-4" />
            </Button>
          </div>
          <TrendingFeed />
        ...
        <section className="gradient-charcoal rounded-3xl p-8 text-center space-y-4">
          <h2 className="font-display text-2xl md:text-3xl font-bold text-white">
            Own a Salon? <span className="text-gold-400">List it for Free!</span>
          </h2>
