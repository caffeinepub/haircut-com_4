...
export default function Blog() {
  ...
  useEffect(() => {
    ...
    setMetaDescription(
      "Read expert tips, salon trends, and beauty insights from the Haircut.com team.",
    );
    setOpenGraphTags(
      "Blog - Haircut.com",
      "Read expert tips, salon trends, and beauty insights from the Haircut.com team.",
  ...
  const samplePosts: BlogPost[] = [
    {
      ...
      excerpt:
        "Discover the hottest haircut styles dominating salons across India this year, from textured crops to bold bobs.",
    ...
    },
    {
      ...
      excerpt:
        "Not all salons are created equal. Learn how to find the perfect salon that specializes in your unique hair texture and needs.",
      coverImageUrl: "/assets/generated/blog-cover-default.dim_1200x600.png",
    ...
    },
    {
      ...
      excerpt:
        "Unisex salons are transforming the grooming landscape in Indian cities. Here's why they're becoming the preferred choice.",
      coverImageUrl: "/assets/generated/blog-cover-default.dim_1200x600.png",
      author: "Haircut.com Team",
      ...
      <section className="bg-gradient-to-br from-charcoal to-charcoal-light py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Expert tips, salon trends, and grooming guides from the Haircut.com
            team.
          </p>
        </div>
      </section>
              ...
              >
                <div className="relative overflow-hidden h-48">
                  <img
                    src={
                      post.coverImageUrl ||
                      "/assets/generated/blog-cover-default.dim_1200x600.png"
                    }
                    alt={post.title}
