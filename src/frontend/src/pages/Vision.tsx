...
import { Eye, Globe, Heart, Zap } from "lucide-react";
...
export default function Vision() {
  useEffect(() => {
    ...
    setMetaDescription(
      "Discover Haircut.com's vision to become India's leading salon booking platform, founded by Jikesh Kumar.",
    );
  }, []);
      ...
      <section className="bg-gradient-to-br from-charcoal to-charcoal-light py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto leading-relaxed">
            A world where every Indian has access to quality grooming services,
            and every salon owner has the tools to thrive.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-5xl mx-auto px-4 py-12">
        ...
        <div className="bg-gradient-to-r from-gold/20 to-gold/5 border border-gold/30 rounded-2xl p-8 mb-16 text-center">
          ...
          <p className="text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto italic">
            "To become India's most trusted salon booking platform — where
            technology meets tradition, and every haircut tells a story of
            quality, convenience, and community."
          </p>
          <p className="text-gold mt-4 font-medium">
            — Jikesh Kumar, Founder & CEO
          </p>
        </div>
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
            Vision <span className="text-gold">Pillars</span>
          </h2>
        ...
        <div>
          <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
            Our <span className="text-gold">Roadmap</span>
          </h2>
            ...
            {[
              {
                year: "2024",
                milestone: "Launch",
                desc: "Platform launch in Bihar with 50+ salons. Core booking and payment features.",
              },
              {
                year: "2025",
                milestone: "Expansion",
                desc: "Expand to 10 major Indian cities. Launch Prime Membership and referral program.",
              },
              {
                year: "2026",
                milestone: "Scale",
                desc: "Reach 500+ salons, 25+ cities. Launch AI recommendations and AR features.",
              },
              {
                year: "2028",
                milestone: "Leadership",
                desc: "Become India's #1 salon booking platform with 50,000+ salons nationwide.",
              },
