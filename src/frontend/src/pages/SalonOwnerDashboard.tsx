...
export function SalonOwnerDashboard() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-6">
      <h1 className="text-2xl font-bold text-foreground mb-6">Owner Dashboard</h1>
      <Tabs defaultValue="bookings">
        ...
        <TabsContent value="promotions"><PromotionsSection /></TabsContent>
    ...
    <div className="space-y-4">
      ...
      {bookings?.length === 0 ? (
        ...
        bookings?.map(booking => (
          <div key={booking.id} className="bg-card border border-border rounded-2xl p-4 space-y-3">
            <div className="flex items-start justify-between gap-3">
              ...
              <div className="text-right flex-shrink-0">
                <Badge className={cn('text-xs mb-1', STATUS_STYLES[booking.status])}>
                  {booking.status}
                </Badge>
...
function ScheduleManagement() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="font-semibold text-foreground mb-3">Available Time Slots</h2>
  ...
  return (
    <div className="space-y-4">
      <div className="gradient-gold rounded-2xl p-5 shadow-gold">
        <p className="text-charcoal-800 font-semibold text-sm mb-1">Pending Payout</p>
        <p className="text-3xl font-bold text-charcoal-900">
          ₹{earnings?.pendingPayout?.toLocaleString('en-IN')}
        </p>
        <p className="text-charcoal-700 text-xs mt-1">Next payout: This weekend</p>
      </div>
      ...
      <div className="bg-card border border-border rounded-2xl p-4 space-y-2">
        ...
        <div className="flex justify-between text-sm">
          <span className="text-muted-foreground">Commission Deducted (10%)</span>
        ...
        <div>
          ...
          <div className="space-y-2">
            {coupons.map(c => (
              ...
              >
                <div>
                  <span className="font-mono font-bold text-gold-600 dark:text-gold-400">{c.code}</span>
    ...
    <div className="space-y-6">
      <div className="bg-card border border-border rounded-2xl p-5 space-y-4">
        ...
        <div className="border-2 border-dashed border-border rounded-2xl p-8 text-center space-y-3">
          ...
          <p className="text-xs text-muted-foreground">Showcase your salon, work, and ambiance</p>
