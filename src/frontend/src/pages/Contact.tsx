...
import { MapPin, Phone, Mail, User, Loader2, CheckCircle } from 'lucide-react';
...
export default function Contact() {
  ...
  useEffect(() => {
    ...
    setMetaDescription("Get in touch with the Haircut.com team. We're here to help!");
  }, []);
      ...
      <section className="max-w-5xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div>
              <h2 className="text-2xl font-bold text-foreground mb-6">Our Contact Details</h2>
              <div className="space-y-5">
                <div className="flex items-start gap-4 p-4 rounded-xl bg-card border border-border">
                  ...
                  <div>
                    <p className="font-semibold text-foreground">Jikesh Kumar</p>
                    <p className="text-muted-foreground text-sm">Founder & CEO, Haircut.com</p>
                  </div>
                </div>
                <div className="flex items-start gap-4 p-4 rounded-xl bg-card border border-border">
                  <div className="w-10 h-10 rounded-full bg-gold/20 flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">Dubauli Dularpur, Bhojpur,<br />Bihar, India – 802206</p>
                  </div>
                </div>
                <div className="flex items-start gap-4 p-4 rounded-xl bg-card border border-border">
                  <div className="w-10 h-10 rounded-full bg-gold/20 flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    ...
                    <a href="tel:+919693567545" className="text-gold hover:underline text-sm">+91 9693567545</a>
                  </div>
                </div>
                <div className="flex items-start gap-4 p-4 rounded-xl bg-card border border-border">
                  <div className="w-10 h-10 rounded-full bg-gold/20 flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    ...
                    <a href="mailto:hello@haircut.com" className="text-gold hover:underline text-sm">hello@haircut.com</a>
                  </div>
                </div>
              </div>
            </div>
