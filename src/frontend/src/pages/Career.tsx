...
import { BarChart3, Code, HeadphonesIcon, Mail, Megaphone } from "lucide-react";
...
export default function Career() {
  useEffect(() => {
    ...
    setMetaDescription(
      "Join the Haircut.com team and help revolutionize salon booking in India. View open positions.",
    );
  }, []);
      ...
      <section className="bg-gradient-to-br from-charcoal to-charcoal-light py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto leading-relaxed">
            Join Haircut.com and help us transform how India discovers and books
            salon services. We're a passionate team building something
            meaningful.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-5xl mx-auto px-4 py-12">
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
            Why <span className="text-gold">Haircut.com</span>?
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              {
                title: "Impactful Work",
                desc: "Your work directly impacts thousands of salon owners and customers across India every day.",
              },
              {
                title: "Growth Opportunities",
                desc: "We're a fast-growing startup. Early team members grow with the company and take on leadership roles.",
              },
              {
                title: "Flexible Culture",
                desc: "We believe in results over hours. Work from anywhere in India with flexible schedules.",
              },
            ].map(({ title, desc }) => (
              <div
                key={title}
        ...
        <div className="mb-16">
          ...
          <div className="space-y-4">
            {openings.map(({ icon: Icon, title, type, location, desc }) => (
              <div
                key={title}
                className="bg-card border border-border rounded-xl p-6 flex flex-col md:flex-row md:items-center gap-4"
              >
                ...
                <a href="mailto:hello@haircut.com?subject=Application: {title}">
                  <Button
                    variant="outline"
                    className="border-gold/50 text-gold hover:bg-gold/10 flex-shrink-0"
                  >
                    Apply Now
                  </Button>
                </a>
        ...
        <div className="bg-gradient-to-r from-gold/20 to-gold/10 border border-gold/30 rounded-2xl p-8 text-center">
          ...
          <p className="text-muted-foreground mb-6">
            ...
            tell us how you can contribute to Haircut.com's mission.
          </p>
