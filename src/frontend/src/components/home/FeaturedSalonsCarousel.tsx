...
function SalonMiniCard({ salon }: { salon: Salon }) {
  ...
  return (
    <button
      type="button"
      onClick={() =>
        navigate({ to: "/salon/$salonId", params: { salonId: salon.id } })
      }
    ...
    >
      ...
      <div className="p-3 space-y-1.5">
        <h3 className="font-semibold text-sm text-foreground line-clamp-1 group-hover:text-gold-500 transition-colors">
          {salon.name}
        </h3>
