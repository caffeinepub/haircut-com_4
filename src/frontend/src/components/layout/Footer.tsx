        ...
        <div className="flex flex-col gap-10 md:flex-row md:justify-between md:gap-8">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-2">
              <p className="text-base font-bold text-foreground">Jikesh Kumar</p>
              ...
              <div className="flex items-center gap-2 text-sm text-foreground/70">
                ...
                <a href="tel:+919693567545" className="hover:text-primary transition-colors">
                  +91 9693567545
                </a>
              </div>
              <div className="flex items-center gap-2 text-sm text-foreground/70">
                <Mail className="h-4 w-4 text-primary shrink-0" />
                <a href="mailto:hello@haircut.com" className="hover:text-primary transition-colors">
                  hello@haircut.com
                </a>
              </div>
            </div>
