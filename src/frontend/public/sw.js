...
const STATIC_ASSETS = [
  '/',
  '/manifest.json',
  '/assets/generated/haircut-pwa-icon-192.dim_192x192.png',
  '/assets/generated/haircut-pwa-icon-512.dim_512x512.png',
        ...
        return caches.match('/').then((cached) => {
          ...
          return new Response(`
            ...
            <html lang="en">
              ...
              <body>
                <img src="/assets/generated/haircut-pwa-icon-192.dim_192x192.png" alt="Haircut.com" onerror="this.style.display='none'" />
